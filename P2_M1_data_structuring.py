...
#DOWNSAMPLE SOUND DATA TO 4KHZ -->100
print("RESAMPLE SOUND DATA")
resample_sound = []
for i in np.arange(len(sound)):
    indices = np.arange(0, len(sound[i]), 8000/100)
...
#DEL SOUND
print("DEL SOUND")
data[0] = data[0][['t0','Accel_x','Accel_y','Accel_z','Gyros_x','Gyros_y','Gyros_z']]
data[1] = data[1][['t0','Accel_x','Accel_y','Accel_z','Gyros_x','Gyros_y','Gyros_z']]
data[2] = data[2][['t0','Accel_x','Accel_y','Accel_z','Gyros_x','Gyros_y','Gyros_z']]
print(data[0])
...
np.save("./P2_M_data_11-14-22.npy", arr=data[0])
np.save("./P2_M_data_11-15-22.npy", arr=data[1])
np.save("./P2_M_data_11-16-22.npy", arr=data[2])
