...
#LOAD DATA SETS
X = np.load("./P2_M_training_data.npy",allow_pickle=True)
y = np.load("./P2_M_labels.npy")
...
np.save("./P2_M_ML_Project_performance.npy", hist.history)
...
print(y_pred.shape)
print(y_true.shape)
np.save("./P2_M_y_true.npy", arr=y_true)
np.save("./P2_M_y_pred.npy", arr=y_pred)
