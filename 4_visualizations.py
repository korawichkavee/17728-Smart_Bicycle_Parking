...
training_performance = np.load("./ML_Project_performance.npy", allow_pickle=True)
...
fig_loss.savefig("./performance_loss.png")
...
fig_accuracy.savefig("./performance_accuracy.png")
