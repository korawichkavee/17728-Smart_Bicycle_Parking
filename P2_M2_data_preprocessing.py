...
#LOAD DATASETS
data_11_14_22 = np.load("P2_M_data_11-14-22.npy")
data_11_15_22 = np.load("P2_M_data_11-15-22.npy")
data_11_16_22 = np.load("P2_M_data_11-16-22.npy")
print("DATA LOADED")
...
np.save("./P2_M_training_data.npy", arr=X)
np.save("./P2_M_labels.npy", arr=y)
