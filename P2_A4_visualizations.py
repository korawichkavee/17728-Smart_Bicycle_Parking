...
y_true = np.load("./P2_A_y_true.npy")
y_pred = np.load("./P2_A_y_pred.npy")

training_performance = np.load("./P2_A_ML_Project_performance.npy", allow_pickle=True)
...
disp.plot()
plt.savefig("./P2_A_confusion_matrix_test.png")
...
fig_loss.savefig("./P2_A_performance_loss.png")
...
fig_accuracy.savefig("./P2_A_performance_accuracy.png")
