...
#DEL MOTION
print("DEL MOTION")
data[0] = data[0][['t0','sound_amplitude']]
data[1] = data[1][['t0','sound_amplitude']]
data[2] = data[2][['t0','sound_amplitude']]
print(data[0])
...
np.save("./P2_A_data_11-14-22.npy", arr=data[0])
np.save("./P2_A_data_11-15-22.npy", arr=data[1])
np.save("./P2_A_data_11-16-22.npy", arr=data[2])
