...
#LOAD DATA SETS
X = np.load("./training_data.npy",allow_pickle=True)
...
np.save("./ML_Project_performance.npy", hist.history)
...
print(y_pred.shape)
print(y_true.shape)
np.save("./y_true.npy", arr=y_true)
np.save("./y_pred.npy", arr=y_pred)
