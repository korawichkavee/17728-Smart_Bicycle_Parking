...
#LOAD DATASETS
data_11_14_22 = np.load("data_11-14-22.npy")
data_11_15_22 = np.load("data_11-15-22.npy")
data_11_16_22 = np.load("data_11-16-22.npy")
print("DATA LOADED")
...
step_rate = 1
window_size = 20000 # 20000/4000 = 5 --> 5/2 = 2.5 sec
mu = 0
...
np.save("./training_data.npy", arr=X)
np.save("./labels.npy", arr=y)
